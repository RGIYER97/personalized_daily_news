...
def fetch_news() -> str:
    ...
    prompt = (
        ...
        "Below are raw headlines grouped by section. For EACH section, produce a short bulleted "
        "digest of ONLY the most critical stories, obeying that section's bullet cap.\n\n"
        f"{combined}\n\n"
        "STRICT RULES:\n"
        ...
        "8. Cover only events of genuine U.S. national or worldwide significance. "
        "Skip local crime, celebrity gossip, sports, lifestyle, and opinion pieces.\n"
        "9. NEVER copy or quote article titles verbatim. Synthesize in your own words.\n"
        "10. NEVER attribute to a source ('BBC reports', 'per WSJ'). State facts directly.\n"
        "11. If a section has no genuinely new, notable developments from the last 24 hours, "
        "write exactly one line (no bullet): 'No major new developments reported today.'\n"
        "12. Do NOT add any intro sentence, closing sentence, or meta-commentary.\n\n"
        "Begin."
    )
